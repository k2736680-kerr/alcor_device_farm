 ...
 */
import type { AuditEventPage } from './auditEventPage';
import type { AuditEventListEnvelopeError } from './auditEventListEnvelopeError';

export interface AuditEventListEnvelope {
  request_id: string;
  data: AuditEventPage;
  /** @nullable */
  error: AuditEventListEnvelopeError;
}
